...
// JAVÍTVA: Játék szerkesztési logika hozzáadva
...
window.toggleGameEditMode = function(firestoreId) {
    ...
    const statusControlsRow = document.getElementById(`game-status-controls-${firestoreId}`); // Kijátszottam/Törlés sor
    ...
    if (!isEditing) {
        ...
        statusControlsRow.style.display = 'none'; // Elrejtjük a Kijátszottam/Törlés gombokat
        ...
        statusControlsRow.style.display = 'flex'; // Megmutatjuk a Kijátszottam/Törlés gombokat
...
window.renderLists = function() { 
    ...
    filteredList.forEach(item => {
        ...
        // JAVÍTVA: Közvetlen onclick eseménykezelő
...
window.renderGameLists = function() {
    ...
    filteredList.forEach(item => {
        ...
        li.setAttribute('data-id', item.firestoreId);
        ...
        // JAVÍTVA: Mindkét osztályt megkapja (style.css-ben javítottuk a megjelenést)
        deleteBtn.className = 'title-action-btn delete-button-matched'; 
        ...
        editButton.className = 'title-action-btn edit-button';
        editButton.title = 'Adatok szerkesztése';
        // JAVÍTVA: Közvetlen onclick eseménykezelő a toggleGameEditMode-hoz
        ...
        saveButton.style.display = 'none'; 
        saveButton.title = 'Adatok mentése';
        // JAVÍTVA: Közvetlen onclick eseménykezelő a saveGameItem-hez
...
// JAVÍTVA: A handleListClick függvény és a document.addEventListener('click', handleListClick); Eltávolítva/Kikommentelve, mivel a közvetlen onclick a megbízhatóbb.
